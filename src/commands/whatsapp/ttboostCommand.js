...
const VALID_TYPES = ['video_views', 'like', 'followers'];
...
async function handleTtBoost(sock, msg, args) {
    ...
    if (!args.length) {
        return sock.sendMessage(jid, {
            text: applyFont('🚀 TIKTOK BOOST — USAGE\n\n', 'bold') +
                ...
                '`.ttboost https://www.tiktok.com/@user/video/123456 | like`\n' +
    ...
    if (!VALID_TYPES.includes(type)) {
        return reply(sock, msg,
            ...
            `✅ *Valid types:* \`video_views\`, \`like\`, \`followers\``
        );
    }
