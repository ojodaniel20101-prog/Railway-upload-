...
const COMMAND_RULES = {
  ...
  suspend:       { category: 'group management', subCategory: 'moderation', roleRequired: 'admin', groupOnly: true, emoji: '⏸️' },
  tempsilence:   { category: 'group management', subCategory: 'moderation', roleRequired: 'admin', groupOnly: true, emoji: '⏸️' },
